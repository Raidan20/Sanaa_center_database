...
function createCustomIcon(eventType) {
        let color;
        switch (eventType) {
            case 'US Strikes on Houthi-Controlled Territories':
                color = '#d17cc7';
                break;
            case 'Israel Strikes on Houthi-Controlled Territories':
                color = '#09ab8d';
                break;
            case 'Houthi Operations Against US Forces and Israel':
                color = '#9b39e1';
                break;
            case 'Houthi Attacks on Shipping':
                color = '#ff9900';
                break;
            case 'Frontline Fighting with Houthi Forces':
                color = '#c72409';
                break;
            case 'Fighting Clash with Al-Qaeda':
                color = '#1e8e3e';
                break;
            case 'Drones and Missiles':
                color = '#1d27e1';
                break;
            case 'Landmine':
                color = '#d3c210';
    ...
    function createPopupContent(event) {
        ...
        return `
            <table>
                ...
                ${addRow('Location', event.Directorate)}
                ${addRow('Type', event.Location)}
...
const legendTypes = [
        { color: '#d17cc7', label: 'US Strikes on Houthi-Controlled Territories' },
        { color: '#09ab8d', label: 'Israel Strikes on Houthi-Controlled Territories' },
        { color: '#9b39e1', label: 'Houthi Operations Against US Forces and Israel' },
        { color: '#ff9900', label: 'Houthi Attacks on Shipping' },
        { color: '#c72409', label: 'Frontline Fighting with Houthi Forces' },
        { color: '#1e8e3e', label: 'Fighting Clash with Al-Qaeda' },
        { color: '#1d27e1', label: 'Drones and Missiles' },
...
function addMarkers(events) {
    ...
    events.forEach(event => {
        if (event.Coordinates) {
            ...
            const marker = L.marker([lat, lng], { icon: createCustomIcon(event.Event_Type) })
